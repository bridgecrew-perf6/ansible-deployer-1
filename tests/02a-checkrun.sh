...
# Check dry run
check_message_in_output "ansible-deployer run --dry --debug --task task_exec_bin_true --stage prod --infrastructure testInfra" "\[INFO\]: Skipping execution because of --dry-run option"
check_message_not_in_output "ansible-deployer run --dry --debug --task task_exec_bin_true --stage prod --infrastructure testInfra" "\[DEBUG\]: Started lock_inventory for lockdir"
...
check_message_in_output "ansible-deployer run --task task_with_ansible_fail --stage testing --infrastructure testInfra" "\[ERROR\]: \"ansible-playbook -i ./test_infra1_inv.yaml runll.yaml\" failed due to"
check_message_not_in_output "ansible-deployer run --task task_with_ansible_fail --stage testing --infrastructure testInfra" "\[INFO\]: \"ansible-playbook -i ./test_infra1_inv.yaml runBinTrue.yaml\" ran succesfully"
