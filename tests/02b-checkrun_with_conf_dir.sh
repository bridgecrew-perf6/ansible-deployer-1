...
# # Always skip
check_message_not_in_output "ansible-deployer run --task task_skipping --stage testing --infrastructure testInfra2 --conf-dir=/etc/alternate-deployer-dir" "ran succesfully"# # Never skip
...
check_message_in_output 'ansible-deployer run --task task_with_ansible_fail --stage testing --infrastructure testInfra --conf-dir=/etc/alternate-deployer-dir' "\[ERROR\]: \"ansible-playbook -i ./test_infra1_inv.yaml runll.yaml\" failed due to"
check_message_not_in_output 'ansible-deployer run --task task_with_ansible_fail --stage testing --infrastructure testInfra --conf-dir=/etc/alternate-deployer-dir' "\[INFO\]: \"ansible-playbook -i ./test_infra1_inv.yaml runBinTrue.yaml\" ran succesfully"
